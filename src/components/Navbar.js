...
function Navbar() {
  return (
    ...
    <nav className="flex items-center justify-between w-full h-18 shadow">
        ...
        <span className=" my-0 mx-5 sm:mx-1">
      <motion.img animate={{ x:20 }} transition={{ duration: 20, type: "spring", stiffness: 900 }} src={logo} className="w-32 cursor-pointer hover:animate-bounce"/>
        ...
        <ul className="float-right inline-flex">
            ...
            <li className="text-xl p-2 mx-4 
                          text-cyan-900 
                          hover:text-cyan-900
                          cursor-pointer hover:animate-ping"><img src={menu} className="w-8 sm:w-12" /></li>
                          <li className="text-xl p-2 mx-4 
                          text-cyan-900 
                          hover:text-cyan-900
                          cursor-pointer hover:animate-ping"><img src={cart} className="w-8 sm:w-12" /></li>
        </ul>
    </nav>
